...
function creatediv(dside) {
    ...
    for (i = 0; i < m; i++) {
        ...
        for (j = 0; j < n; j++) {
            ...
            a.style.backgroundImage = "url(./images/"+picsize+"."+num+".jpg)"
    ...
    d = document.getElementsByClassName("col "+(m*n))[0];
    d.style.opacity = "0";
...
function swapBlock(x, y) {
    ...
    var newtext = document.getElementsByClassName(x)[0].style.backgroundImage;
    document.getElementsByClassName(x)[0].style.backgroundImage = document.getElementsByClassName(y)[0].style.backgroundImage;
    document.getElementsByClassName(y)[0].style.backgroundImage = newtext;
}
